...
export default function NavBar() {
    ...
    return (
        ...
        <>
            <header className='text-black fixed w-full m d:absolute z-10' >
                <nav className='flex px-3 md:px-12 py-2 justify-between items-center   bg-purple-600 text-white' id='nav'>
                    <div className='part-1 flex items-center '>
                        <span className='text-2xl md:text-3xl cursor-pointer text-white font-medium'>#Sanskruti</span>
                    </div>
                    ...
                    {/* NavDocker */}
                    <div className='nav-doc md:hidden w-full  border-4 p-2 border-white bg-[#ff4040] text-white flex justify-center items-center absolute left-0 right-0 top-12 -translate-x-[1000px] transition-all z-[999999] ' id='nav-doc'>
